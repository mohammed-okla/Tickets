...
const roleFeatures = {
  passenger: ['Digital wallet access', 'QR code payments', 'Event ticket purchases', 'Transaction history'],
  driver: ['Driver dashboard', 'Earnings tracking', 'QR code generation', 'Trip management'],
  merchant: ['Business dashboard', 'Payment processing', 'Analytics & insights', 'Customer management'],
  event_admin: ['Event creation', 'Ticket management', 'Attendee analytics', 'Revenue tracking']
}
      ...
      <div className="w-full max-w-4xl relative">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-white/70 text-sm">Join the digital payment revolution</span>
          </div>
        </div>
            ...
            <Card className="bg-black/40 backdrop-blur-xl border-white/10 shadow-2xl">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-gray-400">
                  Get started with your digital wallet in minutes
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="userRole" className="text-white">Account Type</Label>
                    <Select
          ...
          >
            <Card className="bg-black/40 backdrop-blur-xl border-white/10">
              <CardHeader>
                <CardTitle className="text-white flex items-center gap-2">
                  ...
                  {formData.userRole === 'passenger' && 'Personal Account Features'}
                  {formData.userRole === 'driver' && 'Driver Account Features'}
                  {formData.userRole === 'merchant' && 'Business Account Features'}
                  {formData.userRole === 'event_admin' && 'Event Organizer Features'}
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-black/40 backdrop-blur-xl border-white/10">
              <CardContent className="p-6">
                <h3 className="text-white font-semibold mb-4">Why Choose Tickets?</h3>
                <div className="space-y-3 text-sm text-gray-400">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                    <span>Instant transactions & real-time updates</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                    <span>Low fees & transparent pricing</span>
                  </div>
                </div>
              </CardContent>
            </Card>
